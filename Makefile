MODULE_NAME = koo_hd_video_record_with_fastboot
# DIRs
...
MEDIA_INC_PATH = $(NVT_HDAL_DIR)/vendor/media/include
HDAL_LIB_PATH = $(NVT_HDAL_DIR)/output
MEDIA_LIB_PATH = $(NVT_HDAL_DIR)/vendor/output
VENDOR_ISP_INC_PATH = $(NVT_HDAL_DIR)/vendor/isp/include
# INC FLAGs
EXTRA_INCLUDE += -I$(HDAL_INC_PATH) -I$(VOS_INC_PATH) -I$(MEDIA_INC_PATH) -I$(VENDOR_ISP_INC_PATH)
.PHONY: all clean
###############################################################################
# Linux Makefile                                                              #
###############################################################################
...
LD_FLAGS	= -L$(HDAL_LIB_PATH) -L$(MEDIA_LIB_PATH) -lhdal -lpthread -lvendor_media -lvendor_isp
#--------- END OF ENVIRONMENT SETTING -------------
LIB_NAME = $(MODULE_NAME)
SRC = \
	koo_video_record_with_fastboot.c \
	mem_hotplug.c
