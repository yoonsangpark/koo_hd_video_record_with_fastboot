...
static UINT32 RESOLUTION_SET = 0; //0: 2M(IMX290), 1:5M(OS05A), 2: 2M (OS02K10), 3: 2M (AR0237IR), 4: (PATTERN_GEN), 5: 2M (F37), 6: 2M (F35), 7: 4M (GC4653), 8: 3M (Q03P)
static char * SENSOR_NAME_TBL[] = {"sen_imx290", "sen_os05a10", "sen_os02k10", "sen_ar0237ir", "sen_off", "sen_f37", "sen_f35", "sen_gc4653", "sen_q03p"};
static UINT32 VDO_SIZE_W_TBL[] = {1920, 2592, 1920, 1920, 1920, 1920, 1920, 2560, 2304};
static UINT32 VDO_SIZE_H_TBL[] = {1080, 1944, 1080, 1080, 1080, 1080, 1080, 1440, 1296};
...
static HD_RESULT mem_init(void)
{
	...
	mem_cfg.pool_info[4].blk_size = 0x100000;
...
static HD_RESULT set_cap_cfg(HD_PATH_ID *p_video_cap_ctrl)
{
	...
	if(RESOLUTION_SET == 0 || RESOLUTION_SET == 1 || RESOLUTION_SET == 2 || RESOLUTION_SET == 5 || RESOLUTION_SET == 6 || RESOLUTION_SET == 7 || RESOLUTION_SET == 8) {
